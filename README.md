...
* **founding eng** @ leechy *(rental marketplace • 10k users, 50+ businesses)*
...
* **[shipsafe](https://github.com/RonCodes88/ShipSafe)** — autonomous multi-agent vulnerability scanner with AST code parsing, patch generation & remediation
...
* **[bizvision](https://github.com/RonCodes88/BizVision)** — edge-cv & multi-agent system providing real-time inventory perception for visually impaired owners *(1st place)*
